...
test('Validação de e-mails com a utilização do dominio @gmail.com',()=>{
    expect(ValidarEmail("foo.bar@gmail.com")).toBe(true)
})

test('Validação de e-mails com a adição do dominio .br',()=>{
    expect(ValidarEmail("foo.bar@gmail.com.br")).toBe(true)
})

test('Validação de e-mails com o adicional de dois dominios .b',()=>{
